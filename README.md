...
*itt van egy kis angol szöveg, de alatta ott van magyarul is!*
...
### Nyitott kultúrával készült, a nyitott kultúráért!

Minden kódomat és művészeti alkotásomat a [Creative Commons Zero](http://creativecommons.org/publicdomain/zero/1.0/) un-licenc alatt teszem közkinccsé. Ami azt jelenti, hogy ha remixelni akarod ezt, hogy elkészítsd a saját túlságosan meta játékodat, vagy használd egy prezentációban, osztályteremben vagy bármi másban, már megvan az engedélyem!

Azonban nem *minden* kód/művészet az enyém. Ahol a tisztelet jár, ott a tisztelet is jár, szóval...

**CODE:**    
- [PIXI.js](https://github.com/pixijs/pixi.js), a grafika megjelenítéséhez (MIT License)    
- [Howler.js](https://github.com/goldfire/howler.js), a hangok lejátszásához (MIT License)
...
**ART:**    
- A befejezéshez módosítottam [ezt a laptopról készült fotót](https://unsplash.com/photos/XyNi3rUEReE). (CC Zero)
