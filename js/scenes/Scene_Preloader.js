...
function Scene_Preloader(){
	...
	// Loading text
	var text = new PIXI.Text("loading... 0%", {font:"25px Tahoma, sans-serif", fill:"#4C4C4C", align:"center"});
    text.anchor.x = 0.5;
    text.anchor.y = 0.5;
    text.x = bar.x;
    text.y = bar.y;
